...
## Project Structure
    ...
    ├── connectordelete_dev_68646  # Django project configurations
...
1. Clone this repo and `cd connectordelete_dev_68646`
...
2. Clone this repo and `cd connectordelete_dev_68646`
